...
export function UnifiedSocialProof() {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          {statsItems.map((item, idx) => (
            <Card
              key={idx}
              className="relative p-5 md:p-6 text-center hover-elevate transition-all neomorphic overflow-hidden group"
            ...
            >
              ...
              <div className="relative z-10 space-y-3">
                ...
                <div className="flex justify-center">
                  <div className="p-2.5 rounded-lg bg-emerald-100 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition-transform duration-300">
                    {item.icon}
                  </div>
                </div>

                {/* Value */}
                <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-emerald-600 to-emerald-700 dark:from-emerald-400 dark:to-emerald-500 bg-clip-text text-transparent">
          ...
          {trustItems.map((item, idx) => (
            ...
            >
              ...
              <div className="relative z-10 space-y-3">
                ...
                {/* Trust Value */}
                <div className="text-sm md:text-base font-bold text-emerald-600 dark:text-emerald-400">
                  {item.value}
                </div>
      ...
      {/* Live Activity Badge */}
      <div className="flex justify-center">
        <div className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-gradient-to-r from-emerald-50 to-emerald-50/50 dark:from-emerald-950/30 dark:to-emerald-950/10 border border-emerald-200/50 dark:border-emerald-800/30">
          <div className="h-2 w-2 rounded-full bg-emerald-500 dark:bg-emerald-400 animate-pulse" />
          <span className="text-sm font-medium text-emerald-700 dark:text-emerald-300">
            👥 847 emails checked today • 🔒 0 security breaches ever
          </span>
        </div>
      </div>
    </div>
